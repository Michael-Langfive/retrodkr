...
class CopyGeneratorRetroDKRLossCompute(CommonCopyGeneratorLossCompute):
    """Search Retro Copy Generator Loss Computation."""
    def __init__(self, criterion, generator, tgt_vocab, normalize_by_length,
                 lambda_coverage=0.0):
        super(CopyGeneratorRetroDKRLossCompute, self).__init__(criterion, generator,
                                                        tgt_vocab,
                                                        normalize_by_length,
